								...
								<div class="widget-content">							  
									...
									<div class="bs-example">
										<ul id="myTab" class="nav nav-tabs">
											...
											<li class="active"><a href="#application.root#receipts"><i class="fa fa-usd"></i> Receipts</a></li>
										...
										<div class="tab-content">
											...
											<h6 style="font-weight:900;">RECEIPT SCHEDULE</strong></h6>
											<p style="margin-top:5px;">{{ receipts }}</p>
										</div>
