								...
								<div class="widget-content">							  
									...
									<div class="bs-example">
										<ul id="myTab" class="nav nav-tabs">
											...
											<li class="active"><a href="#application.root#settlements"><i class="fa fa-building"></i> Settlement Summary</a></li>												
										...
										<div class="tab-content">
											...
											<h6 style="font-weight:900;">SETTLEMENT SUMMARY</strong></h6>
											<p style="margin-top:5px;">{{ settlement summary }}/p>
										</div>
