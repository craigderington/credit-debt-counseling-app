								...
								<div class="widget-content">							  
									...
									<div class="bs-example">
										<ul id="myTab" class="nav nav-tabs">
											...
											<li class="active"><a href="#application.root#docs"><i class="fa fa-folder-open-o"></i> Client Documents</a></li>
										...
										<div class="tab-content">
											...
											<h6 style="font-weight:900;">CLIENT DOCUMENT LIBRARY</strong></h6>
											<p style="margin-top:5px;">{{ list of uploaded client document }}/p>
										</div>
