								...
								<div class="widget-content">							  
									...
									<div class="bs-example">
										<ul id="myTab" class="nav nav-tabs">
											...
											<li class="active"><a href="#application.root#fees"><i class="fa fa-briefcase"></i> Client Fees</a></li>
										...
										<div class="tab-content">
											...
											<h6 style="font-weight:900;">PROGRAM FEES PAID BY CLIENT</strong></h6>
											<p style="margin-top:5px;">{{ program fees paid by client }}/p>
										</div>
