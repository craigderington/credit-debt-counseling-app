								...
								<div class="widget-content">
									...
									<div class="bs-example">
										<ul id="myTab" class="nav nav-tabs">
											...
											<li><a href="#application.root#program"><i class="fa fa-th-large"></i> Program Summary</a></li>
											<li><a href="#application.root#debtworksheet"><i class="fa fa-th-list"></i> Debt Worksheet</a></li>
											<li class="active"><a href="#application.root#personaldata"><i class="fa fa-user-secret"></i> Personal Data</a></li>
									...
									{{ personal data client data // content }}
